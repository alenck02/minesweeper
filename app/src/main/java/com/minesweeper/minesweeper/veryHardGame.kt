...
@SuppressLint("NewApi")
class veryHardGame : AppCompatActivity() {
    ...
    private val rowCount = 39
    private val columnCount = 24
    private val mineCount = 200
    ...
    private val currentIndex = 3

    @SuppressLint("MissingInflatedId", "ClickableViewAccessibility")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_very_hard_game)

        scrollView = findViewById(R.id.very_hard_scrollView)
        frameLayout = findViewById(R.id.very_hard_frameLayout)
        gridLayout = findViewById(R.id.very_gridlayout_hard_game_board)

        chronometer = findViewById(R.id.very_hard_chronometer)
        flagButton = findViewById(R.id.very_hard_btn_flag)
        mineLeft = findViewById(R.id.very_hard_mine_left)
        ...
        if (!isKeepGameCalled()) {
            RewardedAd.load(this, adUnitId, adRequest, object : RewardedAdLoadCallback() {
                override fun onAdFailedToLoad(adError: LoadAdError) {
                    Toast.makeText(this@veryHardGame, "Failed to road Ad", Toast.LENGTH_SHORT).show()
                ...
                override fun onAdLoaded(rewardedAd: RewardedAd) {
                    ...
                    rewardedAd.show(this@veryHardGame, object : OnUserEarnedRewardListener {
