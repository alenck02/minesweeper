...
@SuppressLint("NewApi")
class medGame : AppCompatActivity() {
    ...
    private val rowCount = 16
    private val columnCount = 16
    private val mineCount = 40
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_med_game)

        scrollView = findViewById(R.id.scrollView)
        frameLayout = findViewById(R.id.frameLayout)
        gridLayout = findViewById(R.id.gridlayout_mid_game_board)

        chronometer = findViewById(R.id.mid_chronometer)
        flagButton = findViewById(R.id.mid_btn_flag)
        mineLeft = findViewById(R.id.mid_mine_left)
        ...
        if (!isKeepGameCalled()) {
            RewardedAd.load(this, adUnitId, adRequest, object : RewardedAdLoadCallback() {
                override fun onAdFailedToLoad(adError: LoadAdError) {
                    Toast.makeText(this@medGame, "Failed to road Ad", Toast.LENGTH_SHORT).show()
                    onAdFailed()
                }
                ...
                override fun onAdLoaded(rewardedAd: RewardedAd) {
                    ...
                    rewardedAd.show(this@medGame, object : OnUserEarnedRewardListener {
