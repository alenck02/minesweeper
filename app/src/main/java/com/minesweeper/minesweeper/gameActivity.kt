...
class gameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scrollView = findViewById(R.id.easy_scrollView)
        frameLayout = findViewById(R.id.easy_frameLayout)
        gridLayout = findViewById(R.id.gridlayout_easy_game_board)

        chronometer = findViewById(R.id.easy_chronometer)
